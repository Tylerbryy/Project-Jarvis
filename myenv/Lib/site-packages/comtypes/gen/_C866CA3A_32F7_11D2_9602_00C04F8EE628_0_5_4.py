...
__all__ = [
    ...
    'DISPID_SLWs_NewEnum', 'SVSFIsFilename', 'STSF_AppData',
    'SPPS_RESERVED2', 'DISPID_SGRInitialState', 'SPPHRASERULE',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRCEAdaptation',
    'SRATopLevel', 'DISPID_SPIAudioStreamPosition', 'SRAImport',
    'eLEXTYPE_PRIVATE10', 'SAFTGSM610_11kHzMono',
    'SAFTADPCM_11kHzStereo', 'SpeechRuleAttributes',
    'SPEI_RECOGNITION', 'DISPID_SLWWord', 'SpeechRegistryUserRoot',
    'DISPID_SpeechPhraseReplacements', 'SpeechAddRemoveWord',
    'DISPID_SRRecognizer', 'DISPID_SGRsItem', 'SAFT22kHz16BitMono',
    'DISPID_SVVolume', 'DISPID_SRSSupportedLanguages', 'SITooLoud',
    'SAFT32kHz16BitMono', 'DISPID_SRCESoundEnd',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRCCreateResultFromMemory',
    'SLTApp', 'SAFT16kHz8BitMono', 'SECLowConfidence',
    'DISPID_SRGDictationUnload', 'ISpeechRecognizerStatus',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpPhoneConverter',
    'DISPID_SRCERecognizerStateChange', 'SDA_No_Trailing_Space',
    'DISPID_SREmulateRecognition', 'DISPID_SPRuleChildren', 'SVP_17',
    'DISPID_SLGetPronunciations', 'DISPID_SLPsItem',
    'DISPID_SPARecoResult', 'DISPID_SLPSymbolic',
    'DISPID_SRCEEndStream', 'SPLOADOPTIONS',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPCIdToPhone',
    'SpeechCategoryPhoneConverters', 'SVSFParseMask',
    'DISPID_SGRSTsItem', 'SVP_6', 'SpeechEngineConfidence',
    'DISPID_SRRAudioFormat', 'SPEI_SENTENCE_BOUNDARY', 'SP_VISEME_4',
    'DISPID_SLGetWords', 'DISPID_SVPriority', 'SpeechGrammarState',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPRNumberOfElements', 'tagSPPROPERTYINFO',
    'SPEI_RESERVED3', 'DISPID_SPIEnginePrivateData',
    'ISpeechAudioStatus', 'DISPID_SVEStreamEnd',
    'DISPID_SGRSTransitions', 'ISpeechLexiconPronunciations',
    'DISPID_SVSLastResult', 'SVSFIsXML', 'ISpeechAudioFormat',
    'DISPID_SDKEnumValues', 'SRCS_Enabled', 'DISPID_SVAudioOutput',
    'SpeechTokenKeyAttributes', 'DISPID_SPEAudioTimeOffset',
    'STCLocalServer', 'eLEXTYPE_PRIVATE6', 'SP_VISEME_16',
    'SpeechAllElements', 'SINone', 'SRAExport',
    'SpeechCategoryAudioIn', 'SPEI_SOUND_START', 'eWORDTYPE_ADDED',
    'SPINTERFERENCE_NOISE', 'SPINTERFERENCE_NOSIGNAL',
    'SGRSTTWildcard', 'SPBO_NONE',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SFSOpen',
    'SSSPTRelativeToCurrentPosition', 'ISpeechPhraseProperties',
    'SDKLCurrentConfig', 'DISPID_SPEPronunciation',
    'SpeechAudioState', 'DISPID_SPEs_NewEnum', 'SVEPrivate',
    'DISPID_SPPFirstElement', 'DISPID_SRGetFormat', 'SPGRAMMARSTATE',
    'DISPID_SpeechFileStream', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SGRSTsCount', 'ISequentialStream', 'STCAll',
    'SpFileStream', 'ISpeechVoice', 'SPSTREAMFORMATTYPE',
    'DISPID_SPRuleConfidence', 'SREPropertyStringChange',
    'SRTSMLTimeout', 'SGRSTTWord', 'SAFT44kHz8BitStereo', 'SBOPause',
    'SPEI_END_SR_STREAM', 'DISPID_SGRs_NewEnum', 'DISPID_SGRsCount',
    'SpUnCompressedLexicon', 'SAFT24kHz8BitMono', 'SVEAudioLevel',
    'SAFTADPCM_8kHzStereo', 'SVPOver', 'SAFT48kHz8BitMono',
    'ISpeechPhraseProperty', 'SVP_16',
    'DISPID_SVSLastStreamNumberQueued', 'SECFIgnoreCase',
    '_RemotableHandle', 'DISPID_SRCEInterference', 'SVP_9',
    'SPVOICESTATUS', 'SpeechWordType',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVEventInterests',
    'DISPID_SpeechPhraseRule', 'ISpMMSysAudio', 'DISPID_SASState',
    'eLEXTYPE_VENDORLEXICON', 'SP_VISEME_2', 'DISPID_SPAsItem',
    'ISpeechObjectTokenCategory', 'SPINTERFERENCE_LATENCY_WARNING',
    'SRSEIsSpeaking', 'DISPID_SGRsCommit',
    'DISPID_SpeechWaveFormatEx', 'ISpeechPhraseReplacements',
    'SPPHRASEELEMENT', 'DISPID_SRSCurrentStreamNumber',
    'ISpeechRecoResult', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SGRSTPropertyValue', 'ISpeechLexiconWord',
    'ISpeechPhraseElement', 'SPEI_VISEME', 'SPCS_DISABLED',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRSClsidEngine',
    'ISpeechGrammarRuleStateTransition',
    'SpPhoneticAlphabetConverter', 'DISPID_SOTCId',
    'SWPUnknownWordPronounceable', 'DISPID_SVGetProfiles',
    'SSTTTextBuffer', 'DISPID_SRCERecognition',
    'DISPID_SPAPhraseInfo', 'ISpeechPhraseRules',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SWFEBlockAlign',
    'ISpeechRecoResultTimes', 'SVSFParseSsml',
    'ISpeechRecoResultDispatch', 'SP_VISEME_6',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRGetRecognizers',
    'SpeechRegistryLocalMachineRoot', 'SPEI_MIN_SR',
    'SREInterference', 'DISPID_SVSInputSentenceLength', 'SPFILEMODE',
    'DISPID_SPRulesItem', 'SPEI_ADAPTATION', 'SPAUDIOBUFFERINFO',
    'SP_VISEME_7', 'DISPID_SGRSTType', 'SAFTCCITT_ALaw_11kHzMono',
    'SPWF_SRENGINE', 'DISPID_SpeechPhraseReplacement',
    'SAFT12kHz8BitMono', 'SpeechTokenIdUserLexicon',
    'DISPID_SRRTLength', 'Speech_StreamPos_RealTime',
    'SRTExtendableParse', 'DISPID_SPPsCount', 'SRERequestUI',
    'ISpeechBaseStream', 'DISPID_SpeechAudioFormat',
    'SDA_One_Trailing_Space', 'SPAUDIOSTATUS', 'SPAO_NONE',
    'SpeechGrammarTagWildcard', 'SDKLDefaultLocation', 'SVP_0',
    'eLEXTYPE_LETTERTOSOUND', 'SPSERIALIZEDRESULT', 'ISpLexicon',
    'SINoSignal', 'SAFTADPCM_44kHzStereo', 'SpNullPhoneConverter',
    'DISPID_SPRs_NewEnum', 'SPSHT_OTHER', 'ISpRecoResult',
    'SAFT16kHz16BitMono', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'ISpeechFileStream', 'SpeechRunState', 'SPRECORESULTTIMES',
    'DISPID_SPIStartTime', 'DISPID_SAEventHandle', 'SPPS_Noncontent',
    'eLEXTYPE_PRIVATE7', 'SPAR_Medium', 'SpSharedRecognizer',
    'DISPID_SRCESoundStart', 'SREAllEvents',
    'SPRST_INACTIVE_WITH_PURGE', 'SpeechDiscardType',
    'DISPID_SRCVoice', 'SPEI_TTS_BOOKMARK', 'SPEI_RESERVED1',
    'DISPID_SDKGetStringValue', 'DISPID_SDKSetStringValue',
    'SREHypothesis', 'SpeechCategoryRecognizers',
    'SAFT12kHz16BitMono', 'DISPID_SGRsDynamic', 'SPRS_INACTIVE',
    'eLEXTYPE_PRIVATE3', 'SECHighConfidence',
    'DISPID_SRRGetXMLResult', 'DISPID_SVSRunningState',
    'SAFT22kHz8BitStereo', 'SGSExclusive', 'DISPID_SRCBookmark',
    'DISPID_SOTGetAttribute', 'DISPID_SVSpeakStream',
    'DISPID_SRGRules', 'SpeechDictationTopicSpelling', 'SPSLMA',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRCEBookmark', 'SVP_11',
    'SpeechRecoEvents', 'eWORDTYPE_DELETED',
    'DISPID_SGRSTPropertyName', 'DISPID_SPRulesCount',
    'SPWAVEFORMATTYPE', 'SPGRAMMARWORDTYPE', 'ISpeechGrammarRule',
    'SPRECOGNIZERSTATUS', 'SpObjectToken', 'SPCS_ENABLED',
    'eLEXTYPE_PRIVATE13', 'STCInprocServer', 'DISPID_SLWLangId',
    'ISpEventSink', 'ISpPhrase', 'DISPID_SRRSaveToMemory',
    'DISPID_SRCEEnginePrivate', 'SAFTNonStandardFormat',
    'DISPID_SASCurrentDevicePosition',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SAFGuid',
    'DISPID_SLGetGenerationChange', 'SECNormalConfidence',
    'SPXMLRESULTOPTIONS', 'SGSDisabled',
    'DISPID_SpeechAudioBufferInfo', 'SRARoot', 'SPFM_NUM_MODES',
    'DISPID_SLGenerationId', 'DISPID_SOTsItem', 'SPWF_INPUT',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpStream', 'SSTTWildcard',
    'DISPID_SPEAudioSizeTime', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SOTDataKey', '_ISpeechRecoContextEvents', 'SWTDeleted',
    'SRTEmulated', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SpeechPropertyResourceUsage', 'DISPID_SPPNumberOfElements',
    'SpLexicon', 'SRTAutopause', 'DISPID_SLPs_NewEnum',
    'DISPID_SpeechBaseStream', 'DISPID_SGRSRule',
    'DISPID_SpeechLexiconWord', 'SPEI_HYPOTHESIS',
    'DISPID_SABufferNotifySize', 'SPTEXTSELECTIONINFO',
    'ISpeechAudioBufferInfo', 'SDTLexicalForm', 'SpeechTokenKeyFiles',
    'DISPID_SRCEHypothesis',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'DISPIDSPRG',
    'DISPID_SGRAddState', 'SPEI_MAX_SR', 'SVSFNLPMask',
    'SPFM_OPEN_READWRITE', 'SDTDisplayText',
    'SpeechCategoryRecoProfiles', 'SAFTADPCM_22kHzMono',
    'ISpRecoContext', 'SpeechRecoProfileProperties',
    'DISPID_SVEAudioLevel', 'SITooSlow', 'SpMMAudioOut',
    'SAFT24kHz16BitMono', 'SPEVENTENUM', 'DISPID_SpeechVoiceStatus',
    'SPRST_ACTIVE', 'DISPID_SBSSeek', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SOTId', 'SRSInactive', 'ISpPhoneConverter',
    'SPEI_REQUEST_UI', 'SPWORDTYPE', 'SPAO_RETAIN_AUDIO',
    'SAFTADPCM_22kHzStereo', 'ISpAudio', 'DISPID_SRStatus',
    'DISPID_SVSInputSentencePosition', 'ISpeechDataKey',
    'SPEI_RESERVED5', 'DISPID_SPEAudioStreamOffset',
    'ISpeechCustomStream', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPRS_ACTIVE',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SpeechObjectTokens',
    'DISPID_SWFEBitsPerSample', 'DISPID_SOTIsUISupported',
    'DISPID_SRSCurrentStreamPosition', 'ISpeechAudio', 'SASPause',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SDKGetlongValue',
    'SPPS_RESERVED1', 'SpeechTokenShellFolder',
    'DISPID_SOTGetStorageFileName', 'SPCT_SUB_DICTATION',
    'SpWaveFormatEx', 'DISPID_SGRsAdd', 'SVEPhoneme',
    'DISPID_SAFType', 'DISPID_SpeechMemoryStream', 'SECFIgnoreWidth',
    'tagSPTEXTSELECTIONINFO', 'eLEXTYPE_PRIVATE8', 'SVP_10',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SpeechPhraseRules', 'SVP_12',
    'SPVPRI_ALERT', 'SPPS_Unknown', 'SPGS_DISABLED', 'SPINTERFERENCE',
    'DISPID_SPRuleId', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SLRemovePronunciation', 'SPVPRI_NORMAL', 'SREBookmark',
    'DISPID_SPRDisplayAttributes', 'SpeechStreamSeekPositionType',
    'DISPID_SVEBookmark', 'SAFT22kHz16BitStereo', 'SpeechLoadOption',
    'DISPIDSPTSI_ActiveLength', 'SpeechGrammarTagDictation',
    'SP_VISEME_3', 'DISPID_SRRTOffsetFromStart',
    'SpeechRetainedAudioOptions', 'ISpeechResourceLoader', 'SPSNoun',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRProfile',
    'SPBINARYGRAMMAR', 'DISPID_SGRSAddWordTransition',
    'DISPID_SPRuleName', 'DISPID_SLWsCount', 'DISPID_SPPValue',
    'SPEI_TTS_PRIVATE', 'SRSActiveAlways', 'SP_VISEME_0',
    'SpeechTokenValueCLSID', 'DISPID_SPIEngineId', 'SPEI_UNDEFINED',
    'SAFTADPCM_44kHzMono', 'DISPID_SPRuleFirstElement',
    'ISpXMLRecoResult', 'SpMMAudioIn', 'SPWORDPRONUNCIATION',
    'ISpShortcut', 'DISPID_SGRName', 'eLEXTYPE_PRIVATE20',
    'SAFT44kHz16BitStereo', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechAudioFormatType', 'ISpPhoneticAlphabetSelection',
    'SREPrivate', 'SFTInput', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRState', 'DISPID_SABIEventBias', 'SVPNormal', 'SLTUser',
    'DISPID_SRCEStartStream', 'SpeechTokenContext',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpRecoContext2',
    'SPEI_START_INPUT_STREAM', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRGCmdSetRuleState', 'SPEI_START_SR_STREAM',
    'SpeechFormatType', 'SLODynamic', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRCEAudioLevel', 'SDTReplacement', 'ISpProperties',
    'SPPROPERTYINFO', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SPRules_NewEnum', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SpeechPhraseElements', 'DISPID_SPIAudioSizeTime',
    'SPPS_Interjection', 'SAFT8kHz8BitStereo', 'SP_VISEME_21',
    'SPDKL_CurrentConfig', 'SAFT48kHz16BitMono',
    'SAFT11kHz8BitStereo', 'SVP_3', 'ISpeechRecoGrammar',
    'SPLO_STATIC', 'SAFTCCITT_uLaw_8kHzStereo', 'SRERecognition',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'IEnumString',
    'SPEI_RESERVED2', 'SPCT_DICTATION', 'SpeechTokenKeyUI',
    'SPEVENTSOURCEINFO', 'SP_VISEME_19', 'SpeechCategoryVoices',
    'DISPID_SMSADeviceId', 'DISPID_SpeechRecoContext',
    'SSFMOpenReadWrite', 'SPRULE', 'DISPID_SPRsItem',
    'SAFT48kHz8BitStereo', 'SAFT12kHz16BitStereo',
    'ISpeechPhoneConverter', 'SP_VISEME_8', 'DISPID_SpeechVoice',
    'DISPID_SVSCurrentStreamNumber', 'SASRun',
    'SAFTCCITT_ALaw_44kHzMono',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpMemoryStream',
    'DISPID_SRCCreateGrammar', 'SPBO_TIME_UNITS', 'ISpPhraseAlt',
    'SVP_21', 'DISPID_SRCEPropertyStringChange', 'DISPID_SOTCategory',
    'DISPID_SPRFirstElement', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SVGetVoices', 'SpSharedRecoContext',
    'DISPID_SVSInputWordPosition', 'DISPID_SVESentenceBoundary',
    'SRAInterpreter', 'DISPID_SRCResume',
    'SpeechSpecialTransitionType', 'DISPID_SVEWord',
    'eLEXTYPE_PRIVATE14', 'DISPID_SpeechDataKey',
    'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'eLEXTYPE_PRIVATE5',
    'SPCATEGORYTYPE', 'ISpeechPhraseAlternate',
    'DISPID_SGRSTs_NewEnum', 'STSF_LocalAppData', 'WAVEFORMATEX',
    'DISPID_SRGetPropertyNumber', 'SpCompressedLexicon',
    'DISPID_SRGSetWordSequenceData', 'SPPS_SuppressWord',
    'DISPID_SDKDeleteKey', 'DISPID_SABIBufferSize', 'SVSFPersistXML',
    'SP_VISEME_18', 'SPPS_LMA', 'SpeechPropertyComplexResponseSpeed',
    'SpeechGrammarWordType', 'DISPID_SWFEFormatTag',
    'DISPID_SOTRemove', 'SAFT48kHz16BitStereo',
    'DISPID_SOTGetDescription', 'ISpRecoGrammar',
    'DISPID_SASFreeBufferSpace', 'SpeechPartOfSpeech', 'SGDisplay',
    'SPFM_OPEN_READONLY', 'SpeechVoiceSpeakFlags',
    'DISPID_SpeechRecoResult2', 'SECFDefault',
    'DISPID_SRGDictationLoad', 'SAFT11kHz16BitStereo',
    'ISpNotifyTranslator', 'IStream', 'DISPID_SPCLangId',
    'SAFTADPCM_11kHzMono', 'SINoise', 'SGDSInactive', 'ISpRecognizer',
    'DISPID_SGRAddResource', 'SPSEMANTICERRORINFO', 'SRSActive',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SPRuleParent',
    'SpeechInterference', 'SSFMOpenForRead',
    'DISPID_SVGetAudioInputs', 'SPPARTOFSPEECH', 'SP_VISEME_12',
    'DISPID_SMSGetData', 'DISPID_SpeechPhraseBuilder', 'SSFMCreate',
    'eLEXTYPE_RESERVED4', 'SDTPronunciation',
    'SGDSActiveUserDelimited', 'DISPID_SpeechAudioStatus',
    'SAFT8kHz16BitStereo', 'DISPID_SRGDictationSetState',
    'DISPID_SRGCmdSetRuleIdState', 'SVEWordBoundary',
    'SpInProcRecoContext', 'ISpeechGrammarRules', 'DISPID_SRGReset',
    'eLEXTYPE_PRIVATE11', 'SP_VISEME_11', 'DISPID_SPEsItem',
    'SPSNotOverriden', 'Speech_Max_Word_Length',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpTextSelectionInformation',
    'DISPID_SDKGetBinaryValue', 'DISPID_SVResume', 'SRCS_Disabled',
    'ISpeechTextSelectionInformation',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SOTCDefault',
    'SPWORDLIST', 'DISPID_SpeechCustomStream',
    'DISPID_SPPEngineConfidence', 'SVEBookmark',
    'DISPID_SCSBaseStream', 'DISPID_SPRsCount', 'SAFT11kHz16BitMono',
    'ISpeechRecognizer', 'SPBO_AHEAD', 'SPEI_RECO_OTHER_CONTEXT',
    'SDTProperty', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRIsUISupported', 'DISPID_SPEActualConfidence',
    '_ISpeechVoiceEvents', 'DISPID_SVSkip', 'SpInprocRecognizer',
    'SAFTGSM610_22kHzMono', 'DISPID_SpeechGrammarRule',
    'DISPID_SPPName', 'DISPID_SPEDisplayAttributes', 'SVSFIsNotXML',
    'DISPID_SLWType', 'DISPID_SpeechRecoContextEvents',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SASNonBlockingIO',
    'SpeechLexiconType', 'SAFTDefault', 'DISPID_SPIRetainedSizeBytes',
    'DISPIDSPTSI_ActiveOffset', 'SPSHT_NotOverriden',
    'SPEI_PHRASE_START', 'SPADAPTATIONRELEVANCE',
    'DISPID_SVEStreamStart', 'SpeechStreamFileMode',
    'DISPID_SRAudioInput', 'DISPID_SPIGetText', 'SPPS_Verb',
    ...
    'SAFTCCITT_ALaw_22kHzStereo', 'SPEI_RESERVED6', 'SAFTText',
    'ISpDataKey', 'DISPID_SRAudioInputStream', 'SGRSTTRule',
    'SPSInterjection', 'SAFT32kHz8BitMono', 'SpCustomStream',
    'SPEI_FALSE_RECOGNITION', 'SpeechRuleState',
    'SpeechPropertyLowConfidenceThreshold', 'SVP_7',
    'DISPID_SDKOpenKey', 'SPSVerb',
    'DISPID_SpeechLexiconPronunciation', 'SRESoundEnd',
    'SSSPTRelativeToStart', 'DISPID_SRCRetainedAudio',
    'SpeechCategoryAppLexicons', 'DISPIDSPTSI', 'ISpStream',
    'DISPID_SRCEventInterests', 'Speech_StreamPos_Asap',
    'STCInprocHandler', 'DISPID_SPILanguageId', 'ISpRecoGrammar2',
    'ISpNotifySource', 'SRTReSent', 'SPSMF_SAPI_PROPERTIES',
    'SPEI_SR_BOOKMARK', 'SPEI_PHONEME', 'SRSInactiveWithPurge',
    'SGLexicalNoSpecialChars', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRCVoicePurgeEvent', 'SpeechDisplayAttributes',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpeechLexiconPronunciation',
    'SWTAdded', 'SPDKL_DefaultLocation', 'DISPID_SpeechRecoResult',
    'SPFM_CREATE', 'SPINTERFERENCE_TOOLOUD', 'DISPID_SOTCGetDataKey',
    'DISPID_SPPConfidence', 'SREAudioLevel', 'SREPropertyNumChange',
    'SWPUnknownWordUnpronounceable', 'SPSMF_UPS', 'SPPS_NotOverriden',
    'SITooQuiet', 'Speech_Default_Weight',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SVEViseme',
    'SAFT44kHz16BitMono', 'UINT_PTR', 'DISPID_SRCState',
    'SPLEXICONTYPE', 'SAFT8kHz16BitMono', 'DISPID_SVGetAudioOutputs',
    'SGDSActiveWithAutoPause', 'SAFT32kHz16BitStereo', 'SPVISEMES',
    'SP_VISEME_10', 'DISPID_SpeechObjectToken',
    'ISpObjectTokenCategory', 'DISPID_SPIProperties',
    'DISPID_SABufferInfo', 'SVF_Emphasis', 'ISpResourceManager',
    'DISPID_SpeechPhraseProperties', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SRRAlternates', 'SAFT16kHz16BitStereo',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SMSALineId', 'SpeechMicTraining',
    'DISPID_SpeechLexicon', 'SECFIgnoreKanaType', 'SPSFunction',
    'SPPHRASE', 'DISPID_SPERequiredConfidence', 'SGLexical',
    'eLEXTYPE_PRIVATE9', 'SpStreamFormatConverter', 'SPSHORTCUTTYPE',
    'eLEXTYPE_RESERVED9', 'SPPHRASEREPLACEMENT',
    'SpeechVoicePriority', 'DISPID_SRRPhraseInfo', 'STCRemoteServer',
    'DISPID_SLPPartOfSpeech', 'DISPID_SVAlertBoundary',
    'SPCT_SUB_COMMAND', 'SPFM_CREATE_ALWAYS',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SLPLangId',
    'DISPID_SRGCmdLoadFromMemory', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SLPPhoneIds', 'DISPID_SBSRead', 'DISPID_SPPChildren',
    'SVSFParseAutodetect', 'DISPID_SPPs_NewEnum',
    'DISPID_SRCEFalseRecognition', 'SpObjectTokenCategory',
    'DISPID_SWFESamplesPerSec', 'DISPID_SOTCEnumerateTokens',
    'SP_VISEME_17', 'eLEXTYPE_PRIVATE4', 'SVF_None', 'SPPS_Noun',
    'SP_VISEME_1', 'DISPID_SRCERecognitionForOtherContext',
    'ISpObjectWithToken', 'SVESentenceBoundary',
    'SpeechGrammarRuleStateTransitionType', 'SVEViseme',
    'SpeechUserTraining', 'SPDATAKEYLOCATION',
    'DISPID_SRCRequestedUIType', 'DISPID_SRCreateRecoContext',
    'SPEVENT', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SVPAlert', 'DISPID_SRRSetTextFeedback', 'SPEI_RECO_STATE_CHANGE',
    'SpeechRecoContextState', 'SPVPRI_OVER', 'SRESoundStart',
    'DISPID_SPIGrammarId', 'SPEI_WORD_BOUNDARY', 'SpMMAudioEnum',
    'SSTTDictation', 'DISPID_SVSLastBookmark', 'SPPS_Modifier',
    'SPEI_INTERFERENCE', 'DISPID_SASetState', 'SAFTGSM610_44kHzMono',
    'ISpStreamFormat', 'ISpNotifySink', 'DISPID_SGRsFindRule',
    'DISPID_SRDisplayUI', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SpeechLexiconWords', 'SpPhraseInfoBuilder',
    'SPWT_PRONUNCIATION', 'SPSUnknown', 'SREFalseRecognition',
    'SpeechEmulationCompareFlags', 'DISPID_SABIMinNotification',
    'eLEXTYPE_RESERVED8', 'DISPID_SPIRule', 'SRADynamic',
    'DISPID_SGRSTPropertyId', 'SSFMCreateForWrite',
    'SDA_Consume_Leading_Spaces', 'DISPID_SVSPhonemeId',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SpeechLexiconProns',
    'SAFTADPCM_8kHzMono', 'SGSEnabled', 'DISPID_SRRRecoContext',
    'DISPID_SRSNumberOfActiveRules',
    'DISPID_SPPBRestorePhraseFromMemory', 'SREStateChange', 'SVP_4',
    'SBONone', 'DISPID_SOTs_NewEnum', 'SAFT32kHz8BitStereo',
    'DISPID_SpeechGrammarRules', 'SVP_13', 'SVP_18',
    'DISPID_SRGCommit', 'SPAUDIOSTATE', 'SRAONone',
    'SPRST_NUM_STATES', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRRDiscardResultInfo', 'eLEXTYPE_RESERVED7', 'SVP_14',
    'SPAR_Unknown', 'SPWORD', 'SPSHT_EMAIL', 'SPINTERFERENCE_TOOSLOW',
    'SFTSREngine', 'SpeechPropertyResponseSpeed', 'SPDKL_CurrentUser',
    'ISpeechPhraseReplacement', 'DISPID_SGRClear',
    'ISpPhoneticAlphabetConverter', 'DISPID_SpeechMMSysAudio',
    'SpVoice', 'SREAdaptation', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SVWaitUntilDone',
    'SPAR_Low', 'ISpeechLexiconWords', 'DISPID_SVEVoiceChange',
    'DISPID_SRSetPropertyNumber', 'SVEVoiceChange', 'SPWT_LEXICAL',
    'DISPID_SRCPause', 'DISPID_SpeechPhraseAlternates',
    'ISpRecognizer3', 'eLEXTYPE_PRIVATE2', 'SpeechCategoryAudioOut',
    'SDA_Two_Trailing_Spaces', 'SPEI_SR_PRIVATE',
    'DISPID_SRSetPropertyString', 'DISPID_SOTCreateInstance',
    'SPCT_COMMAND', 'DISPID_SPAs_NewEnum', 'DISPID_SVIsUISupported',
    'DISPID_SpeechPhoneConverter', 'DISPID_SVDisplayUI',
    'DISPID_SDKSetLongValue', 'DISPID_SRGId', 'ISpeechObjectTokens',
    'ISpeechLexicon', 'DISPID_SpeechPhraseProperty',
    'DISPID_SPIElements', 'SPEI_MIN_TTS', 'SVEStartInputStream',
    'STSF_FlagCreate', 'tagSTATSTG', 'SVSFParseSapi',
    'DISPID_SRRAudio', 'SGDSActive', 'SPBO_PAUSE',
    'DISPID_SVSInputWordLength', 'DISPID_SPACommit', 'SPAS_RUN',
    'SPSHORTCUTPAIRLIST', 'DISPID_SGRSTRule', 'SGPronounciation',
    'DISPID_SRSAudioStatus', 'SWPKnownWordPronounceable',
    'SpeechRecognitionType', 'SpeechAudioVolume', 'SVP_15',
    'SITooFast', 'SDKLCurrentUser', 'DISPID_SGRSTText',
    'DISPID_SRGSetTextSelection', 'SAFT24kHz16BitStereo',
    'DISPID_SRRTTickCount', 'DISPID_SVPause', 'DISPID_SLPType',
    'DISPID_SGRsCommitAndSave', 'SP_VISEME_13',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SAStatus',
    'SPSSuppressWord', 'DISPID_SLAddPronunciation',
    'DISPID_SpeechPhraseElement', 'SPSERIALIZEDPHRASE',
    'SPPS_RESERVED3', 'SpResourceManager', 'SRTStandard',
    'DISPID_SPAsCount', 'SPCT_SLEEP', 'SVP_1',
    'DISPID_SDKDeleteValue', 'ISpeechRecoResult2', 'DISPID_SGRId',
    'SpShortcut', 'SP_VISEME_14', 'SAFTCCITT_uLaw_8kHzMono',
    'SPRST_INACTIVE', 'SVEEndInputStream', 'ISpEventSource',
    'ISpeechPhraseAlternates', 'DISPID_SRCRecognizer',
    'SPINTERFERENCE_NONE', 'SPEI_VOICE_CHANGE', 'SVP_8',
    'ISpeechObjectToken', 'SpeechVisemeType', 'DISPID_SMSAMMHandle',
    'ISpeechGrammarRuleState', 'SPEI_MAX_TTS', 'SDTRule',
    'SGRSTTEpsilon', 'DISPID_SVVoice', 'SREPhraseStart',
    'eLEXTYPE_RESERVED6', 'ISpObjectToken',
    'DISPID_SGRSAddRuleTransition', 'SVSFNLPSpeakPunc',
    'DISPID_SVSVisemeId', 'SPVPRIORITY', 'DISPID_SDKEnumKeys',
    '_SPAUDIOSTATE', 'ISpSerializeState', 'SPDKL_LocalMachine',
    'eLEXTYPE_PRIVATE16', 'DISPID_SFSClose', 'DISPID_SPPsItem',
    'DISPID_SRGState', 'DISPID_SAVolume', 'DISPID_SpeechAudio',
    'SAFTExtendedAudioFormat', 'SPRULESTATE', 'DISPID_SWFEExtraData',
    'DISPID_SpeechVoiceEvent', 'SPGS_ENABLED', 'DISPID_SGRSTWeight',
    'SpeechDataKeyLocation', 'DISPID_SpeechObjectTokenCategory',
    'ISpStreamFormatConverter', 'DISPID_SpeechPhraseAlternate',
    'ISpeechGrammarRuleStateTransitions', 'SpeechVisemeFeature',
    'SVP_19', 'SVSFVoiceMask', 'ISpRecoCategory',
    'DISPID_SRRSpeakAudio', 'DISPID_SVRate', 'SPPHRASEPROPERTY',
    'ISpRecognizer2', 'DISPID_SpeechRecognizerStatus',
    'eLEXTYPE_PRIVATE17', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'STSF_CommonAppData', 'SECFEmulateResult',
    'SpeechBookmarkOptions', 'SAFT16kHz8BitStereo', 'SPLO_DYNAMIC',
    'ISpeechPhraseInfo', 'SPINTERFERENCE_TOOQUIET', 'SVP_20',
    'IInternetSecurityManager', 'SVSFlagsAsync',
    'ISpeechMemoryStream', 'SPPS_Function', 'DISPID_SRIsShared',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPSHORTCUTPAIR',
    'DISPID_SWFEChannels', 'ISpeechMMSysAudio',
    'SpeechRecognizerState', 'DISPID_SVStatus', 'SPXRO_SML',
    'SAFT24kHz8BitStereo', 'DISPID_SPEEngineConfidence',
    'SVSFUnusedFlags', 'SpeechAudioProperties', 'SASStop',
    'SPGS_EXCLUSIVE', 'SAFT22kHz8BitMono',
    'DISPID_SRRGetXMLErrorInfo', 'SRADefaultToActive', 'SVF_Stressed',
    'SECFNoSpecialChars', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SVEPhoneme', 'ISpeechPhraseElements',
    'SPEI_END_INPUT_STREAM', 'SpeechEngineProperties',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPIReplacements',
    'SP_VISEME_15', 'SAFT8kHz8BitMono', 'Speech_Max_Pron_Length',
    'DISPID_SMSSetData', 'ISpGrammarBuilder', '__MIDL_IWinTypes_0009',
    'DISPID_SPAStartElementInResult', 'SVSFDefault',
    'SpeechAudioFormatGUIDWave', 'SPAS_STOP', 'SAFT44kHz8BitMono',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFTNoAssignedFormat', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpeechPhraseInfoBuilder', 'SPXRO_Alternates_SML',
    'DISPID_SPRText', 'DISPID_SRGIsPronounceable', 'SPCONTEXTSTATE',
    'ISpVoice', 'DISPID_SPCPhoneToId', 'eLEXTYPE_PRIVATE12',
    'SPRECOCONTEXTSTATUS', 'SpeechAudioFormatGUIDText',
    'SPAUDIOOPTIONS', 'SPAR_High', 'SPRECOSTATE', 'SDTAll',
    'DISPID_SRGRecoContext', 'SPSModifier',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SVSpeak', 'SPWT_DISPLAY',
    'DISPID_SpeechPhraseInfo', 'IInternetSecurityMgrSite',
    'DISPID_SOTSetId', 'DISPID_SRGetPropertyString',
    'ISpeechVoiceStatus', 'DISPID_SpeechRecognizer', 'eLEXTYPE_USER',
    'DISPID_SPEDisplayText', 'SP_VISEME_9', 'DISPID_SDKCreateKey',
    'ISpeechWaveFormatEx', 'DISPID_SOTsCount',
    'DISPID_SADefaultFormat', 'SRERecoOtherContext', 'SPSHT_Unknown',
    'SPSEMANTICFORMAT', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SVEAllEvents', 'eLEXTYPE_PRIVATE18', 'DISPID_SGRAttributes',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SVAudioOutputStream',
    'SpeechPropertyAdaptationOn', 'DISPID_SLPsCount', 'LONG_PTR',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRRTimes',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SBSWrite', 'DISPID_SPPId', 'ISpeechRecoContext',
    'DISPID_SpeechRecoResultTimes', 'SAFTTrueSpeech_8kHz1BitMono',
    'ISpeechPhraseRule', 'SRSEDone', 'SPAS_PAUSE',
    'SpNotifyTranslator', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SPEsCount', 'ISpeechXMLRecoResult', 'SPEI_SOUND_END',
    'DISPID_SRCSetAdaptationData', 'SPWORDPRONUNCIATIONLIST',
    'SASClosed', 'SpeechVoiceEvents', 'SDTAudio', 'SRAORetainAudio',
    'SLOStatic', 'eLEXTYPE_RESERVED10',
    'SpeechPropertyHighConfidenceThreshold', 'SGRSTTDictation',
    'eLEXTYPE_APP', 'SSSPTRelativeToEnd', 'SVP_5', 'SpAudioFormat',
    'eLEXTYPE_PRIVATE19', 'SPBOOKMARKOPTIONS', 'IEnumSpObjectTokens',
    'SP_VISEME_5', 'SDKLLocalMachine', 'DISPID_SRRTStreamTime',
    'DISPID_SBSFormat', 'SAFT11kHz8BitMono', 'eLEXTYPE_PRIVATE15',
    'DISPID_SPEAudioSizeBytes', 'SAFT12kHz8BitStereo', 'SP_VISEME_20',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SLWsItem', 'DISPID_SRGCmdLoadFromObject', 'SPAS_CLOSED',
    'SpeechWordPronounceable', 'DISPID_SOTCSetId',
    'DISPID_SVEEnginePrivate', 'SREStreamEnd', 'SDTAlternates',
    'SPPS_RESERVED4', 'SPWORDPRONOUNCEABLE', 'DISPID_SRCEPhraseStart',
    'DISPID_SPPParent', 'DISPID_SOTDisplayUI', 'SVSFPurgeBeforeSpeak',
    'SREStreamStart', 'SVP_2', 'eLEXTYPE_PRIVATE1',
    'SAFTGSM610_8kHzMono'
]
